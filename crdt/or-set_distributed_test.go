...
func TestDistributedORSet(t *testing.T) {
	...
	if err != nil {
		t.Fatalf("[crdt_test.TestDistributedSet] Expected test environment creation not to fail but received: %s\n", err.Error())
	}
	...
	if err != nil {
		t.Fatalf("[crdt_test.TestDistributedSet] Expected no error while loading internal TLS config for worker-1 but received: %s\n", err.Error())
	}
	...
	if err != nil {
		t.Fatalf("[crdt_test.TestDistributedSet] Expected no error while loading internal TLS config for storage but received: %s\n", err.Error())
	}
	...
	if err != nil {
		t.Fatalf("[crdt_test.TestDistributedSet] Expected TLS listen for worker-1 not to fail but received: %s\n", err.Error())
	}
	...
	if err != nil {
		t.Fatalf("[crdt_test.TestDistributedSet] Expected TLS listen for storage not to fail but received: %s\n", err.Error())
	}
	...
	if err != nil {
		t.Fatalf("[crdt_test.TestDistributedSet] Expected InitReceiver() for worker-1 not to fail but received: %s\n", err.Error())
	}
	...
	if err != nil {
		t.Fatalf("[crdt_test.TestDistributedSet] Expected InitReceiverForeground() for storage not to fail but received: %s\n", err.Error())
	}
	...
	if err != nil {
		t.Fatalf("[crdt_test.TestDistributedSet] Expected to be able to connect from worker-1 to storage but received: %s\n", err.Error())
	}
	...
	if err != nil {
		t.Fatalf("[crdt_test.TestDistributedSet] Expected to be able to connect from storage to worker-1 but received: %s\n", err.Error())
	}
	...
	if err != nil {
		t.Fatalf("[crdt_test.TestDistributedSet] Expected InitSender() for worker-1 not to fail but received: %s\n", err.Error())
	}
