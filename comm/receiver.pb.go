...
func (x *receiverIncomingClient) Send(m *Msg) error {
	return x.ClientStream.SendMsg(m)
}

func (x *receiverIncomingClient) CloseAndRecv() (*Closed, error) {
...
func (x *receiverIncomingServer) SendAndClose(m *Closed) error {
	return x.ServerStream.SendMsg(m)
}

func (x *receiverIncomingServer) Recv() (*Msg, error) {
	m := new(Msg)
...
var fileDescriptor0 = []byte{
	...
	,
}
